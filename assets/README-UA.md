...
По суті, __базові редактори__ — [BaseUrlEditor](https://bit.ly/3vXg0qA) и [BasePartEditor](https://bit.ly/3tNXSgZ) охоплюють майже усі задачі: додавання, отримання, оновлення або видалення URL, чи значення у будь якій його частині. __Базові редактори__ — це "CRUDable" огортка над функцією __parse_url()__ з нативного PHP та відповідно із цим фактом, вони повертають та модифікують значення схожим чином. Єдина, істотна відмінність — це синтаксис звернень при парсингу URL або його частин. 
