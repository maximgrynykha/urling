...
__Базові редактори__ — [Базовий редактор URL](https://bit.ly/3vXg0qA) та [Базовий редактор частини URL](https://bit.ly/3tNXSgZ) охоплюють майже усі задачі: *__додавання, отримання, оновлення або видалення__* URL, чи значення у будь якій його частині. __Базові редактори__ — це "CRUDable" обгортка над функцією __parse_url()__ з нативного PHP та відповідно із цим фактом, вони повертають та модифікують значення схожим чином. Єдина, істотна відмінність — це синтаксис звернень при парсингу URL або його частин. 
...
Якщо вам потрібно зробити щось на зразок: *__дадавання, отримання, оновлення або видалення__* значення в будь якій
